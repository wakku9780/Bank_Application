...
public class SBI implements Bankinterface {
    ...
    public int checkBalance(String password) {
        if( this.password==password)return balance;
        return -1;
    }
    ...
    public String addMoney(int money) {
            ...
            String message =money+"hasbeen added to the account"+accountNo+"the totel balance is now"+balance;
    ...
    public String withdrawMoney(int money, String password) {
        if(password==this.password){
            if(money>balance)return "Insufficient balance";
                ...
                balance=balance-money;
                return "money withdraw successfully"+"remaining balanve is"+balance;
            }
        }
